import { collectCoordinatorReadonlyServiceEvidence } from './qrexec-readonly-deployment-evidence-collector.mjs';
...
async function main() {
  try {
    process.stdout.write(await exportCoordinatorReadonlyServiceEvidence());
  } catch {
    process.stderr.write('DIG_QUBES_COORDINATOR_EVIDENCE_EXPORT_FAILED\n');
    process.exitCode = 1;
  }
}
